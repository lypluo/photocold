...
analysis_all_PFTs<-function(df_len5_nonnorm){
...
#for different sites:
out_All<-analysis_all_PFTs(df_len5_nonnorm)


#merge plots
merge_plot_fun<-function(out_all,save.path){
  # out_all<-out_DBF
  # save.path<-save.path
  #--------------
  #I.GPP and LUE
...
print(paste0("All PFTs event observations are:",nrow(df.event)))
print(paste0("All PFTs noevent observations are:",nrow(df.noevent)))
merge_plot_fun(out_All,save.path)
```
