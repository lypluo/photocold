...
load(paste0(path,"Merged_Flux_and_PhenoCam_sel.RDA"))
ddf<-df_merge_sel;rm(df_merge_sel)
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#FR-Fon-->successful
df_andPlot_Cfb_DBF<-sep_data_indiffY_sepMismatch(ddf,0.05,"Cfb","DBF","FR-Fon",c(2006:2013))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#FR-LBr
df_andPlot_Cfb_ENF<-sep_data_indiffY_sepMismatch(ddf,0.05,"Cfb","ENF","FR-LBr",c(2001,2004:2008))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#US-MMS-->successful
df_andPlot_Dfa_DBF<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfa","DBF","US-MMS",c(2000:2014))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#CH-Fru-->successful
df_andPlot_Dfb_GRA1<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","DBF","CH-Fru",c(2006:2014))
...
#IT-MBo:
df_andPlot_Dfb_GRA2<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","GRA","IT-MBo",c(2003:2013))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#DK-Sor-->successful
df_andPlot_Dfb_DBF1<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","DBF","DK-Sor",c(2000:2003,2005:2013))
...
#IT-Col-->successful
df_andPlot_Dfb_DBF2<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","DBF","IT-Col",c(2001,2005,2007:2011,2013:2014))
...
#US-Ha1-->successful
df_andPlot_Dfb_DBF3<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","DBF","US-Ha1",c(2000:2012))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#US-PFa-->successful
df_andPlot_Dfb_MF<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","MF","US-PFa",c(2000:2004,2006:2014))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#CZ-BK1-->successful
df_andPlot_Dfb_ENF1<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","ENF","CZ-BK1",c(2004:2008))
...
#IT-Lav-->successful
df_andPlot_Dfb_ENF2<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","ENF","IT-Lav",c(2003:2014))
...
#RU-Fyo-->successful
df_andPlot_Dfb_ENF3<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfb","ENF","RU-Fyo",c(2000:2001,2003:2014))
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#AT-Neu-->successful
df_andPlot_Dfc_GRA<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","GRA","AT-Neu",c(2002:2012))
length(df_andPlot_Dfc_GRA$p_isevent)
p_diffYears<-df_andPlot_Dfc_GRA$p_isevent
p_merge<-plot_grid(p_diffYears[[1]],p_diffYears[[2]],p_diffYears[[3]],
          p_diffYears[[4]],p_diffYears[[5]],p_diffYears[[6]], 
...
```{r echo = FALSE, message = FALSE, warning = FALSE,fig.height=10,fig.width=10}
#CA-NS1-->successful
df_andPlot_Dfc_ENF1<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","CA-NS1",c(2003:2005))
...
#CA-NS3-->succesful
df_andPlot_Dfc_ENF2<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","CA-NS3",c(2002:2005))
...
#DE-Lkb
df_andPlot_Dfc_ENF3<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","DE-Lkb",c(2010:2013))
...
#US-GLE-->successful
df_andPlot_Dfc_ENF4<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","US-GLE",c(2006:2014))
...
#US-NR1-->successful
df_andPlot_Dfc_ENF5<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","US-NR1",c(2000:2014))
...
#US-Prr-->succesful
df_andPlot_Dfc_ENF6<-sep_data_indiffY_sepMismatch(ddf,0.05,"Dfc","ENF","US-Prr",c(2010:2012))
