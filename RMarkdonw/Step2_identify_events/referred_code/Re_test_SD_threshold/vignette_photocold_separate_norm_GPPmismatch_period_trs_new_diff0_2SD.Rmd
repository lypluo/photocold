...
#save the data:
# save(ddf_labeled,file=paste0(path,"ddf_labeled_norm_trs_newmethod.RDA"))
# save(df_all,file=paste0(path,"df_all_results/df_all_norm_trs_newmethod.RDA"))
...
### steps to determine the "is_event" period
    ...
    **step 5:determine the "is_event" within green-up period**
      ...
      - After some time of consideration, I took following crition to determine the "is_event":
        ...
        1) during the green-up period (sos,peak)-->the data with GPP biases bigger than 2 SD are classified as the "GPP overestimation points"
