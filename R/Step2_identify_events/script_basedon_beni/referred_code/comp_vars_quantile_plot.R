...
fun.path<-"D:/CES/code/R_testcode/PhotoCold/Second_round_of_code/R/Step2_identify_events/Functions/functions_from_YP/"
...
##
save.path<-"C:/Users/yluo/Desktop/R_testcode/PhotoCold/Second_round_of_code/plot/comp_vars/based_Beni/update_results/density_plot/"
##
  df<-df_len5_nonnorm
