...
df_norm_kls_newM_allover_sel<-df_norm_trs_newM_allover[,c("sitename","date","doy","greenup","GS","over_estim","is_event","is_event_less10")]

#
library(reshape2)
df_all<-df_norm_kls_newM_allover_sel
