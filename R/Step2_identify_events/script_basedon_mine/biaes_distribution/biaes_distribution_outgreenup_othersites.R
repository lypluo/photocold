...
load(paste0(load.path,"df_all_results/df_all_norm_trs_newmethod_flag_without_overestimation.RDA"))
#-------------------------------------------------------------------------
...
p_merge<-plot_grid(plot_biaes[[1]],plot_biaes[[2]],plot_biaes[[3]],
                   ...
                   plot_biaes[[10]],plot_biaes[[11]],
                   labels = "auto",ncol=3,label_size = 12,align = "hv")
#save the plot
save.path<-"C:/Users/yluo/Documents/GitHub/photocold/plot/"
plot(p_merge)
ggsave(file=paste0(save.path,"biaes_distribution_out_soseos10_greenup_mv20_trs_flagged_nooverestimation_updated.png"),p_merge,dev="png",width = 10,height=10)
