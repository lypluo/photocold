...
p_model_fluxnet_drivers <- read_rds(paste0("./data/","p_model_fluxnet_drivers.rds"))
#----------------
#data filtering
#----------------
...
# For details on the optimization settings we refer to the manuals of [GenSA]
#(https://cran.r-project.org/web/packages/GenSA/index.html) and [BayesianTools](https://github.com/florianhartig/BayesianTools).
