...
The package(rsofun) includes two demo datasets to run and validate pmodel output. These files can be directly loaded into your workspace by typing "p_model_drivers" and "p_model_validation"
...
```{r}
p_model_drivers_subset<-p_model_fluxnet_drivers%>%
  dplyr::slice(1:3)
...
#plot
# p_gpp_ORG<-ggplot() +
#     geom_point(data = model_data_uncal,
#     aes(date,gpp,col="uncalibrated modeled gpp")) +
#     geom_point(data = model_data_cal,
...
#     labs(x = "Date",y = "GPP(unit)")+
#     theme_classic()+
#     annotate(geom="text",x=as.Date("2005-01-01"),y=15,label="GPP_model_ORG")
# p_gpp_BRC<-ggplot() +
#     geom_point(data = model_data_uncal,
#     aes(date,gpp,col="uncalibrated modeled gpp")) +
#     geom_point(data = model_data_cal,
...
#     labs(x = "Date",y = "GPP(unit)")+
#     theme_classic()+
#     annotate(geom="text",x=as.Date("2005-01-01"),y=15,label="GPP_model_BRC")
p_gpp_FULL<-ggplot() +
    geom_point(data = model_data_uncal,
    aes(date,gpp,col="uncalibrated modeled gpp")) +
    geom_point(data = model_data_cal,
    ...
    labs(x = "Date",y = "GPP(unit)")+
    theme_classic()+
    annotate(geom="text",x=as.Date("2005-01-01"),y=15,label="GPP_model_FULL")
# #
# p_gpp_merge<-plot_grid(p_gpp_ORG,p_gpp_BRC,p_gpp_FULL,
#                       labels = "auto",nrow =3,label_size = 12,align = "hv")
# #
# save.path<-"D:/plots/photocold_project/Temporay_figs/"
# ggsave(paste0(save.path,"gpp_mod_vs_obs.png"),p_gpp_merge,width = 15,height = 10)
