...
for(i in 1:length(df_len5_nonnorm)){
  ...
  df_proc$LUE<-df_proc$gpp/c(df_proc$fapar_itpl*df_proc$ppfd_fluxnet2015) #gpp_obs-->gpp
...
analysis_PFTs<-function(df_len5_nonnorm,PFT_name){
  ...
  #I.GPP and LUE
  #-------------
  #gpp_obs-->variabel:gpp_obs-->gpp
  p_gpp_obs_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"gpp","(umol m-2 s-1)",do_norm = FALSE,do_legend = TRUE,PFT_name)
  #gpp biaes
  ...
  #temp_max
  p_temp_max_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"temp_max_fluxnet2015","(degreeC)",do_norm = FALSE,FALSE,PFT_name)
  #for prec
  p_prec_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"prec_fluxnet2015","(mm)",do_norm = FALSE,do_legend = FALSE,PFT_name)
  #vpd_day
  p_vpd_day_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"vpd_day_fluxnet2015","(Pa)",do_norm = FALSE,do_legend = FALSE,PFT_name)
  #SW_IN
  p_SW_IN_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"SW_IN_fluxnet2015","(W m-2)",do_norm = FALSE,FALSE,PFT_name)
  # TS_1-->first layer soil temperature
  p_TS_1_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"TS_1_fluxnet2015","(degreeC)",do_norm = FALSE,FALSE,PFT_name)
  
  #SWC_1-->first layer soil mosture
  p_SWC_1_len5_b60<-plot_2groups_PFT(df_len5_nonnorm,"SWC_1_fluxnet2015","(%)",do_norm = FALSE,FALSE,PFT_name)
...
#(6) save the plot
#-------------------------------------------------------------------------
save.path<-"D:/plots/photocold_project/Using_sites_in_Fluxnet2015_updatePmodel/quantile_plot/For_different_PFTs/"
#for different sites:
