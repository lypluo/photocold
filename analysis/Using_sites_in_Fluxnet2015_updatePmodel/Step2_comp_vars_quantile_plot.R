...
#do_vars-->the variables that are going to be processed(normalized-->actually does not activiated at this moment):
names(df_norm_all)
...
#(6) save the plot
#-------------------------------------------------------------------------
save.path<-"D:/plots/photocold_project/Using_sites_in_Fluxnet2015_updatePmodel/quantile_plot/"
#merge plots
#--------------
#I.GPP and LUE
#-------------
