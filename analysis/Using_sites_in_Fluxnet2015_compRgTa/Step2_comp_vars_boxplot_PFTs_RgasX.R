...
df_bins<-Classify_Nbins_PFTs(df_len5_nonnorm,c(-60,70),"SW_IN_midday_mean_fluxnet2015",10,FALSE,"DBF")
...
#-------------
#1)classification:
df_bins_SW_IN_DBF<-Classify_Nbins_PFTs(df_len5_nonnorm,c(-60,70),"SW_IN_midday_mean_fluxnet2015",10,FALSE,"DBF")
df_bins_SW_IN_MF<-Classify_Nbins_PFTs(df_len5_nonnorm,c(-60,70),"SW_IN_midday_mean_fluxnet2015",10,FALSE,"MF")
df_bins_SW_IN_ENF<-Classify_Nbins_PFTs(df_len5_nonnorm,c(-60,70),"SW_IN_midday_mean_fluxnet2015",10,FALSE,"ENF")
...
#
p_merge_SW_INandOther_DBF<-merge_plots(df_bins_SW_IN_DBF,"DBF")
ggsave(paste0(save.path,"p_SW_INandother_DBF.png"),p_merge_SW_INandOther_DBF,width = 35,height = 16)
#
p_merge_SW_INandOther_MF<-merge_plots(df_bins_SW_IN_MF,"MF")
ggsave(paste0(save.path,"p_SW_INandother_MF.png"),p_merge_SW_INandOther_MF,width = 35,height = 16)
#
