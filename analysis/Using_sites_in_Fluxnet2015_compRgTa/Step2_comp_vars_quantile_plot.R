...
#update in 2021-12-20:mainly focus on the radiation and Ta-->Environmental variables part
#--------------
#I.GPP and LUE
#-------------
# #gpp_obs
...
#SW_IN_fullday_mean
p_SW_IN_fullday_mean_len5_b60<-plot_2groups(df_len5_nonnorm,"SW_IN_fullday_mean_fluxnet2015","(W m-2)",do_norm = FALSE,FALSE)
#SW_IN_midday_mean
p_SW_IN_midday_mean_len5_b60<-plot_2groups(df_len5_nonnorm,"SW_IN_midday_mean_fluxnet2015","(W m-2)",do_norm = FALSE,FALSE)
#SW_IN_midday_max
p_SW_IN_midday_max_len5_b60<-plot_2groups(df_len5_nonnorm,"SW_IN_midday_max_fluxnet2015","(W m-2)",do_norm = FALSE,FALSE)
#PPFD_fullday_mean
p_PPFD_IN_fullday_mean_len5_b60<-plot_2groups(df_len5_nonnorm,"PPFD_IN_fullday_mean_fluxnet2015","(umol m-2 s-1)",do_norm = FALSE,FALSE)
#PPFD_IN_midday_mean
...
#albedo_ppfd
p_alpha_PPFD_len5_b60<-plot_2groups(df_len5_nonnorm,"alpha_PPFD","",do_norm = FALSE,FALSE)
...
#(6) save the plot
#-------------------------------------------------------------------------
save.path<-"D:/plots/photocold_project/Using_sites_in_Fluxnet2015_compRgTa/quantile_plot/"
#merge plots
#--------------
#I.GPP and LUE
#-------------
...
ggsave(paste0(save.path,"p_EnviroVars.png"),p_merge_EnviroVars,width = 15,height = 30)
#--------------
#III.PhenoCam VIs
#-------------
