...
save.path<-"D:/plots/photocold_project/Using_sites_in_Fluxnet2015_compRgTa/"
plot(p_length)
...
#---------------------------------
save.path<-"D:/data/photocold_project/event_length/Using_sites_in_Fluxnet2015_compRgTa/"
