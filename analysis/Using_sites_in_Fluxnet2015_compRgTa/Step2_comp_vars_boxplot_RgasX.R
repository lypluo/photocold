...
# df_bins<-Classify_Nbins_andPlot(df_len5_nonnorm,c(-60,70),"SW_IN_midday_mean_fluxnet2015",10,FALSE)
...
p_ppfd_midday_mean_tmin<-comp_boxplot(df_bins_ppfd,c("temp_min_fluxnet2015"),TRUE,
                                    c("ppfd midday mean (W m-2)","Minimum Ta (°C)"))
...
ggsave(paste0(save.path,"p_SWandother.png"),p_merge_SWandOther,width = 35,height = 16)
